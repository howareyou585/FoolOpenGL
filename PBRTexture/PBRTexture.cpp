...
#pragma endregion
   ...
   // --------------------------
	unsigned int albedo = TextureFromFile("albedo.png", "../resources/textures/pbr/rusted_iron");
	unsigned int normal = TextureFromFile("normal.png", "../resources/textures/pbr/rusted_iron");
	unsigned int metallic = TextureFromFile("metallic.png", "../resources/textures/pbr/rusted_iron");
	unsigned int roughness = TextureFromFile("roughness.png", "../resources/textures/pbr/rusted_iron");
	unsigned int ao = TextureFromFile("ao.png", "../resources/textures/pbr/rusted_iron");

	//shader
	Shader shader("PBRTexture.vertex", "PBRTexture.frag");
	shader.use();
	for (int i = 0; i < 4; i++)
	{
	...
	//shader.setVec3("albedoMap", glm::vec3(0.5f, 0.0f, 0.0f));
