...
int main(int argc, char** argv)
{
	...
	vecFile.emplace_back(string("bricks2.jpg"));
	vecFile.emplace_back(string("bricks2_disp.jpg"));
	GLuint texId = TextureArrayFromFile(vecFile, "../resources/textures");
	...
	// Section2 准备着色器程序
	Shader shader("TextureArrayDemo.vertex", "TextureArrayDemo.frag");
	shader.use();
