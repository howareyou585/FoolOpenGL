...
int main(int argc, char** argv)
{
	...
	OcclusionCuller ocObj(vecCubeModelColor, vecCubeModelMatrix);
	...
	Shader occlusionShader("OcclusionCuller.vertex", "OcclusionCuller.frag");
	...
	occlusionShader.use();
	occlusionShader.setMat4("view", viewMatrix);
	occlusionShader.setMat4("projection", projection);
