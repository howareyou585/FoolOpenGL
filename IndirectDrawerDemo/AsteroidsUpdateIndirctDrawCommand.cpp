...
int main(int argc, char** argv)
{
	...
	ptrIndirectCommands[0].firstIndex = 0;
	ptrIndirectCommands[0].primCount = 1;
	ptrIndirectCommands[0].baseVertex = 0;
	ptrIndirectCommands[0].count = vaoBuffer.m_vecIndex.size();
