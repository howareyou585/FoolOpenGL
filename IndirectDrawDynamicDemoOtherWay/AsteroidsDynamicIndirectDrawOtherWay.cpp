...
int main(int argc, char** argv)
{
	...
	// Section2 准备着色器程序
	Shader rockShader("DynamicRockIndirectOtherWay.vertex", "DynamicRockIndirectOtherWay.frag");
	Shader plantShader("PlanetInstanceOtherWay.vertex", "PlanetInstanceOtherWay.frag");
