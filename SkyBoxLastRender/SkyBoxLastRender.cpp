...
int main(int argc, char** argv)
{
	...
	// Section2 准备着色器程序
	Shader skyboxShader("skyboxLastRender.vertex","skyboxLastRender.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		projection = camera.GetProjectionMatrix((GLfloat)WINDOW_WIDTH / (GLfloat)WINDOW_HEIGHT, ZOOM);
